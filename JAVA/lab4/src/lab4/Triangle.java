...
public class Triangle extends Draw implements Comparable<Triangle>
{
	private Point a,b,c;
	
	public Triangle(Point a, Point b, Point c, Color figureColor)
    {
		super(figureColor);
        this.a = a;
        this.b = b;
	...
	public void updateCoordinate(double n, double v1, double v2)
	{
 	...
 	public Polygon getPolygon() 
 	{
         ...
         polygon.addPoint((int) a.getV1(), (int) a.getV2());
         polygon.addPoint((int) b.getV1(), (int) b.getV2());
         polygon.addPoint((int) c.getV1(), (int) c.getV2());
         return polygon;
     }
